...
class NightmarePlugin : public IServerPluginCallbacks {
public:
    Game* game;
    Plugin* plugin;
    Modules* modules;
...
public:
    ...
    const char* Version() { return NightmarePlugin_VERSION; }
    const char* Build() { return NightmarePlugin_BUILD; }
    const char* Website() { return NightmarePlugin_WEB; }
...
extern NightmarePlugin nightmarePlugin;
